...
export default function ShopByBrown() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Brown`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        title={<>SHOP BROWN COLOURS</>}
        description={<> The colour brown has taken the centerstage, as the the two most important effects, the wood and the oxidized metal effects, fall under this colour category. Earth tones, naturalness and sobriety characterise settings in this colour. Brown porcelain stoneware offer modern finishes and natural textures.
