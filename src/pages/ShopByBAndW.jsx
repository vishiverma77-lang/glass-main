...
export default function ShopByBAndW() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=B%20And%20W`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY B&W</>}
        description={<> Black & White never ever let you go wrong. Throughout the changing trends, styles and eras black-and-white tiles have remained a true interiors stalwart.They have been a perfect model to convey a discreet elegance</>}
        imageSrc="/images/B&W.jpeg"
      />
      <ShopFilterBar />
