...
export default function ShopByEsprit() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Esprit`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY  ESPRIT</>}
        description={<> The alluring, industrial-inspired look of metallic, oxidised, and rusted porcelain stoneware evokes a sense of weathered, time-worn elegance. The surface of this unique tile material appears to have been stripped and distressed over the years, with hints of metallic sheen peeking through the aged, oxidised layers. The rustic, uneven coloration mimics the natural patina of old iron or steel, creating a captivating visual texture that is at once raw and refined.</>}
        imageSrc="/images/Esprit.jpeg"
      />
      <ShopFilterBar />
