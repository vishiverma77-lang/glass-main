...
export default function ShopByPreciousMetal() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Precious%20Metal`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<>SHOP THE PRECIOUS METAL</>}
        description={<> Porcelain Stoneware with Precious Metal Looks
          Gold, the quintessential symbol of luxury, embodies elegance and sophistication. It is the perfect choice to showcase the richness and opulence of your projects. Let your work shine with the brilliance of gold, making a bold statement that captivates and inspires. Embrace the allure of this precious metal and elevate your endeavors to new heights.

        </>}
        imageSrc="/images/Precious Metal.jpeg"
      />
