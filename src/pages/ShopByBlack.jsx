...
export default function ShopByBlack() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Black`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        ...
        description={<> Black stoneware surfaces immediately express elegance, refinement and sophistication. Elegance and versatlity meet in black porcelain stoneware. Perfect for combinations with neutral tones or bold contrasts, they bring brightness and style to every environment. The result of a precise taste, based on a clearly defined style, the choice of black is often independent of any texture. </>}
