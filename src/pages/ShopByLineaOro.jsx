...
export default function ShopByLineaOro() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Linea%20Oro`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY LINEA ORO</>}
        description={<>Unveil a world of opulence with our gold porcelain stoneware, designed for those who appreciate the extraordinary. The exquisite linear gold accents, paired in unique irregular lines, create a stunning visual experience that transforms any space into luxury interiors with strong personality. When the light hits them they glimmer. </>}
        imageSrc="/images/Linea Oro.jpeg"
      />
      <ShopFilterBar />
