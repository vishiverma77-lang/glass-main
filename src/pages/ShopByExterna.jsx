...
export default function ShopByExterna() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Externa`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY EXTERNA</>}
        description={<>Each piece tells a story, seamlessly blending historical charm with contemporary style. The intricate chevron pattern adds depth and character to any room, creating a striking visual impact. Perfect for those who appreciate both style and history, this flooring option is a true investment in elegance. </>}
        imageSrc="/images/Externa.jpeg"
      />
      <ShopFilterBar />
