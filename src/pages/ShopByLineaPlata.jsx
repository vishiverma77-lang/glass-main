...
export default function ShopByLineaPlata() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Linea%20Plata`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY LINEA PLATA</>}
        description={<> Unveil infinite design possibilities with our platinum silver porcelain stoneware. Its distinctive linear design, in irregular lines, invites architects and interior designers to unleash their creativity Create sophisticated spaces that radiate opulence with our premium platinum silver surfaces. </>}
        imageSrc="/images/Linea Plata.jpeg"
      />
      <ShopFilterBar />
