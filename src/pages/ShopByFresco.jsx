...
export default function ShopByFresco() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Fresco`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY FRESCO</>}
        description={<> Character in porcelain stoneware takes center stage in a collection which is particularly suited to metropolitan spaces with modern furnishings. The three shades - Fresco Blanco, Fresco Grafito and Fresco Moka - are designed to furnish different room types and to meet diverse design requirements.
 </>}
        imageSrc="/images/Fresco.jpeg"
      />
      <ShopFilterBar />
