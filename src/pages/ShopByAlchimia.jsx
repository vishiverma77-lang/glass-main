...
export default function ShopByAlchimia() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Alchimia`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY ALCHIMIA</>}
        description={<>Alchimia a part of the the connoisseur collection helps elevate the interiors with rich mosaic flooring crafted from italian travertine and dark emperador, designed in a unique hexagon shape. The slim borders add a touch of sophistication, making it an choice for hotel lobbies and living rooms. </>}
        imageSrc="/images/Alchimia.jpeg"
      />
      <ShopFilterBar />
