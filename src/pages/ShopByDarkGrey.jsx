...
export default function ShopByDarkGrey() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Dark%20Grey`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        ...
        description={<>Dark grey porcelain stoneware, a distinctive element that elevates any space. Its rich intensity of dark shades brings sense of calm and neutrality, making it an ever-popular design. Perfect for a range of interior styles, this versatile material combines beauty with functionality, enhancing your space with timeless sophistication. Embrace the charm of dark grey stoneware to create a stylish and inviting atmosphere.

        </>}
        imageSrc="/images/Dark Grey.jpeg"
      />
      <ShopFilterBar />
