...
export default function ShopByImperia() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Imperia`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY IMPERIA</>}
        description={<>Imperia connoisseurs collection sheds luxury to your space with the exquisite beauty of classical mosaic laying, featuring italian marble look travertine, dark emperador, statuario and black golden portoro. The stunning combination of these luxurious materials, arranged in a captivating prism shape, creates a visual masterpiece that enhances any interior. </>}
        imageSrc="/images/Imperia.jpeg"
      />
      <ShopFilterBar />
