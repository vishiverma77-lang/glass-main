...
export default function ShopBySerpal() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Serpal`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY SERPAL</>}
        description={<>Ceragres Luxe long hexagon geometric flooring redefines modern elegance, offering a unique twist on traditional designs. Crafted in cement beige, carpet-style prints, and stunning wooden effects, it provides a fresh perspective for contemporary spaces. The luxurious travertine and dark emperador effects add a touch of sophistication, making your designs stand out. This innovative porcelain stoneware format opens up new avenues for architects and designers to explore their creativity. </>}
