...
export default function ShopBySample() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        // Fetch all products (no specific filter)
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      {/* Hero Section */}
      <ShopHero
        title={<>SHOP BY SAMPLE</>}
        description={<>Browse our tiles and choose by clicking " Order Sample". Ensuring you receive a true representation of our premium products.
          Sample our wide selection of tiles & mosaics below. Pick the one you like most.
          LOGIN to get free samples and special pricing. </>}
        imageSrc="/images/"
      />
