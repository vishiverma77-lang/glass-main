...
export default function ShopByWalks() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Walks`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY WALKS</>}
        description={<>The warm tones of this limestone in addition with a Super Touch surface technology reveal high and low reliefs throughout the piece, highlighting the elements that make up this limestone.
Fossils and marine sediments characterize traditional limestone. "Walks" Stone rescues this millennial material with a timeless French aesthetic quality and mood. </>}
