...
export default function ShopByConcrete() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Concrete`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      {/* Hero Section */}
      <ShopHero 
        title={<>Porcelain Stoneware that looks like Concrete</>}
        description="Embrace the industrial vibe with the concrete cement look porcelain stoneware, featuring a stunning resemblance to raw concrete and flaked plaster. Ideal for both residential and commercial applications, this versatile option combines style and strength. Create a striking backdrop that enhances your design vision effortlessly."
        imageSrc="/images/Concrete-tiles.jpeg"
      />
