...
export default function ShopByLaverton() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Laverton`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY  LAVERTON</>}
        description={<>Explore our exquisite selection of <span className="text-blue-600 font-medium lowercase">laverton</span> collections, where each piece is 
