...
export default function ShopByContemporary() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Contemporary`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<>SHOP THE CONTEMPORARY EFFECTS</>}
        description={<> The fresh and dazzling effect of contemporary tiles. Ceragres Luxe contemporary designs, showcase innovative textures and patterns that elevate any space. Whether used for flooring or wall coverings, these tiles add a touch of elegance and sophistication to both residential and commercial interiors.
        </>}
        imageSrc="/images/Contemporary.jpeg"
      />
