...
export default function ShopByPalmaria() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Palmaria`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY PALMARIA</>}
        description={<>Discover the allure of 45° degree angle chevron parquet flooring crafted from rich dark American walnut and dark European walnut. Paired with the opulence of polished golden portoro and dark emperador italian marble look porcelain stoneware, this design exudes luxury. The combination of matte and polished textures creates a lavish atmosphere, perfect for those seeking a bold statementin their space. Make your place a true centerpiece of sophistication. </>}
