...
export default function ShopByChannel() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Channel`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY CHANNEL</>}
        description={<> Our stunning parquet flooring made in a deep dark brown color with an elegant option in  American walnut finish, creates an extraordinary foundation for your space. The small chevron designs add a touch of refinement, ensuring your space stands out. Enjoy the harmonious blend of style and functionality with our premium flooring solution. Redefine your interiors with a classic look that never goes out of style </>}
        imageSrc="/images/Channel.jpeg"
      />
      <ShopFilterBar />
