...
export default function ShopByMarble() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Marble`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<> Porcelain Stoneware that looks like MARBLE </>}
        description={<>The reproduction of marbles on porcelain stoneware, is a perfect example of art becoming art itself, with the marble-look porcelain tiles becoming the ideal synthesis of the wonder of nature and the excellent work of man, who successfully recreates it.</>}
        imageSrc="/images/Marble.jpeg"
      />
