...
export default function ShopByChalet() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Chalet`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY CHALET</>}
        description={<>Linear movements bring dynamism to the surface. Chalet offers a new take on the particular features of the porcelain stone, offering both light and dark shades such as white, beige and grey with a striking, natural look. A succession of soft veining effects. </>}
        imageSrc="/images/Chalet.jpeg"
      />
      <ShopFilterBar />
