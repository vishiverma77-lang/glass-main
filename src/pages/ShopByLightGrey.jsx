...
export default function ShopByLightGrey() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Light%20Grey`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        title={<>SHOP LIGHT GREY COLOUR</>}
        description={<> Exquisite light grey porcelain stoneware is a true tribute to elegance and luminosity. These neutral tones of light grey stoneware are remarkably versatile, making them the perfect choice for any space. Elevate your with the timeless beauty of light grey adding a touch of sophistication to your decor. Discover the endless possibilities stunning stoneware has to offer. </>}
        imageSrc="/images/Light Grey.jpeg"
      />
      <ShopFilterBar />
