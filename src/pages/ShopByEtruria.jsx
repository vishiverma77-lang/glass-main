...
export default function ShopByEtruria() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Etruria`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY ETRURIA</>}
        description={<>Etruria, is something that will hopefully stand beyond trends
.A long tradition in the production of porcelain stoneware is renewed in the encounter with research and experimentation of new styles for contemporary living </>}
        imageSrc="/images/ETRURIA.jpeg"
      />
      <ShopFilterBar />
