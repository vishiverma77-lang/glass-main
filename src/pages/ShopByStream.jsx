...
export default function ShopByStream() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Stream`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY STREAM</>}
        description={<>Unleash the charm of our 1" hexagon parquets, a beloved format that stands the test of time. The distinctive coin-sized dotted effect highlights the stunning wooden grains of light oak, American dark walnut and European walnut, adding depth and character to any floors. Elevate your interiors with these luxurious closely-knit hexagon parquets and create an atmosphere that captivates the viewer. Each piece showcases the natural beauty of wood, making every hexagon a unique work of art. </>}
