...
export default function ShopByNoon() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Noon`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY NOON</>}
        description={<>Ceragres Luxe , noon parquet collection in herringbone wood combines the richness of dark American walnut and oaks for a striking aesthetic. Drawing inspiration from nature, these wooden floors exude warmth and charm. Each piece is crafted to showcase the wood's unique character, creating a stunning visual impact in your projects. Experience a solution that marries beauty with functionality. </>}
