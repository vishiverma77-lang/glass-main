...
export default function ShopByArtisan() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Artisan`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<>SHOP THE ARTISAN EFFECTS</>}
        description={<> Exquisite porcelain stoneware, thoughtfully crafted with inspiration drawn from skilled artisans. Each piece showcases the beauty of traditional craftsmanship, blending elegance with functionality. </>}
        imageSrc="/images/Artisan.jpeg"
      />
