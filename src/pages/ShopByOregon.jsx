...
export default function ShopByOregon() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Oregon`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY OREGON</>}
        description={<>Step into sophistication with our small herringbone parquet flooring, crafted from deep dark brown oak that resembles wenge wood. Complemented by dark oak tones, this design offers a striking contrast that enhances modern interiors. Ideal for those who appreciate bold aesthetics, this flooring will bring both warmth and style your space. Elevate your environment with this timeless choice. </>}
