...
export default function ShopByGatsby() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Gatsby`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY  GATSBY</>}
        description={<>Perfect to elevate any design with a touch of unexpectedness. A little classy. A little quirky. Luxe material and a contemporary chevron pattern, infused with black and white porcelain stoneware along with options in statuario and travertine marble finishes with a brass inlay work in between. This mixed material design is crafted precisely to achieve its intricate design. </>}
        imageSrc="/images/Gatsby.jpeg"
      />
      <ShopFilterBar />
