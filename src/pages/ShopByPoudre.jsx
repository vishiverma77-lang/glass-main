...
export default function ShopByPoudre() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Poudre`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY POUDRE</>}
        description={<> Poudre collection introduces  the gem hexagon porcelain stoneware flooring, a unique and innovative shape designed for architects and designers to explore in their projects. This collection features stunning finishes including cement, italian marble along with the natural woods allowing for applications that go beyond traditional flooring. </>}
