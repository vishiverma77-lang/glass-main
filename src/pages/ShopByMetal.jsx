...
export default function ShopByMetal() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Metal`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<> Porcelain Stoneware that looks like Metal</>}
        description={<>The Metal look replicates material like oxidized and weathered metal, creating urban and industrial-style environments. Leveraging advanced production technologies, porcelain stoneware achieves remarkable realism, making it a high-value solution for modern design and architectural projects.
        </>}
