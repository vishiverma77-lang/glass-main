...
export default function ShopByAlways() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Always`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY ALWAYS</>}
        description={<> Collection "Always" has a contemporary feel: stains, cloudy effects and slight scratches enliven the plain colour of the slate, bringing out the character of the material used and making it more up-to-date.The extremely contemporary colour palette features four neutral shades. </>}
        imageSrc="/images/Always.jpeg"
      />
      <ShopFilterBar />
