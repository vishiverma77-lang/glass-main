...
export default function ShopByMedium() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Medium`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        title={<>SHOP THE MEDIUM FORMATS</>}
        description={<> Discover the charm of medium-sized porcelain stoneware, designed for versatility in any setting. Elevate your space with this timeless choice that combines practicality and style. Medium-sized porcelain stoneware is your go-to solution for enhancing any environment. Transform your spaces with this flexible format that meets both your design and functional needs.
        </>}
        imageSrc="/images/Mid-Formats.jpeg"
      />
      <ShopFilterBar />
