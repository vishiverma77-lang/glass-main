...
export default function ShopByLarge() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Large`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        title={<>SHOP THE  LARGE FORMATS</>}
        description={<> Large porcelain stoneware reduce the number of visual gaps, providing a more seamless and open look. These large formats are a versatile and elegant option to create unique spaces with great visual impact. </>}
