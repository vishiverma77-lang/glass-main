...
export default function ShopByCimone() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Cimone`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY CIMONE</>}
        description={<>Discover the elegance of timeless patterns with our exquisite selection of porcelain stoneware in italian marble effects. Choose from captivating hues like orange alicante, diana and dark emperador, complemented by the classic beauty of beige travertine and travertine marfil. Our collection also offers stunning options in cement beige and greys, perfect for any design aesthetic. Elevate your space with the luxurious appeal of these natural stones. </>}
        imageSrc="/images/Cimone.jpeg"
      />
      <ShopFilterBar />
