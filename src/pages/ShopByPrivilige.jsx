...
export default function ShopByPrivilige() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Privilige`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY PRIVILIGE</>}
        description={<>Embrace individuality with our innovative parquet flooring, showcasing striking trapezium and triangle patterns. Crafted in deep dark walnut and dark oak hues, these unconventional designs are perfect for enhancing and contemporary interiors. Transform your space with parquets that redefine elegance. </>}
