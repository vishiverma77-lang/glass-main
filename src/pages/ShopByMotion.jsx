...
export default function ShopByMotion() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Motion`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY MOTION</>}
        description={<>Motion is a dented, structured and corroded metal. Rough imperfections cut across polished surfaces forging, amazing contrasts. Discoloration and shading reveal experiences, memories and strong emotions. All the three available colors oxido, corten and azul are intense, bold, richly shaded and detailed. Motion is an original, distinctive collection, that reveals a lot about those who choose it </>}
