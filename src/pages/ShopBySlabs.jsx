...
export default function ShopBySlabs() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Slabs`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        title={<>SHOP BY SLABS</>}
        description={<>  Thanks to technological development, design and innovation. Ceragres Luxe Slabs are here, to take on contemporary architectural projects. Providing a blank canvas for designers and architects to unleash their creativity.
        </>}
        imageSrc="/images/Slabs.jpeg"
      />
      <ShopFilterBar />
