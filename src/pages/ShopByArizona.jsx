...
export default function ShopByArizona() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?series=Arizona`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY ARIZONA</>}
        description={<>The accurate play of oblique lines inside the porcelain stoneware module, gives the floor exact movement and liveliness. A meticulous composition of wooden abstract patterns gives life to a characteristic geometric texture. Arizona collection creates a delicate movement effect, by creating a sense of comfort at a glance. </>}
        imageSrc="/images/Arizona.jpeg"
      />
      <ShopFilterBar />
