...
export default function ShopBySpruzzaOro() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Spruzza%20Oro`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY SPRUZZA ORO</>}
        description={<> Specchio means spray. Ceragres Luxe oro collection is inspired by the spray effect done with the pvd technology. Immerse yourself in  the elegance of our elite collection in gold, featuring a captivating spruzza effect that enhances the allure of porcelain stoneware. Each piece is designed to bring opulence and glamour to your interiors.</>}
