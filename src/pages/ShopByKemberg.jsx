...
export default function ShopByKemberg() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Kemberg`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY KEMBERG</>}
        description={<> The Kemberg pattern is composed of porcelain stoneware with a stone look, slightly raised to give character to your walls. The set of Oldy patterns and their erased tone brings an authentic look to your projects.The collection is inspired by the world of handcrafted techniques, where irregularities and imperfections testify to the passage of time and the hands of artisans, making these stoneware unique. </>}
        imageSrc="/images/Kemberg.jpeg"
      />
      <ShopFilterBar />
