...
export default function ShopByWood() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Wood`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<> Porcelain Stoneware that looks like Wood</>}
        description={<>Exquisite selection of wood effect porcelain stoneware that beautifully capture the warmth and essence of nature. Each tile faithfully reproduces intricate veins, knots, and tones found in the finest woods, making them a perfect addition to any space. Transform your home with bespoke shapes of our stunning tile collection. Embrace the charm of wood without compromising on practicality.</>}
        imageSrc="/images/wood.jpeg"
      />
