...
export default function ShopByBlue() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Blue`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        ...
        description={<> Blue is a versatile shade in porcelain stoneware, embodying the freshness of seas and skies. It symbolizes calm, intensity, and, making it an ideal choice for any space. This color brings a serene yet vibrant energy, enhancing the beauty of your surroundings. Embrace the tranquility of blue and transform your environment with its soothing presence.
        </>}
