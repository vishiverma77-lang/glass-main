...
export default function ShopByCalabria() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Calabria`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY CALABRIA</>}
        description={<> Inspired by the material suggestions of hand-worked stone, the collection brings the decoration of indoor and outdoor walls into a new dimension of contemporary interior design, where attention to detail and the authenticity of the structure confer a natural character to any living space. </>}
        imageSrc="/images/Calabria.jpeg"
      />
      <ShopFilterBar />
