...
export default function ShopByHeritage() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Heritage`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY HERITAGE</>}
        description={<>Featuring a blend of travertine, dark emperador, orange alicante and statuario, this flooring option offers a sophisticated and timeless appeal. Each piece is meticulously designed to create an intricate pattern that captivates you and enhances the overall ambiance. Transform your space into a masterpiece with this elegant mosaic flooring solution. </>}
        imageSrc="/images/Heritage.jpeg"
      />
      <ShopFilterBar />
