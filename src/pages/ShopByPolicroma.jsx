...
export default function ShopByPolicroma() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Policroma`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY  POLICROMA</>}
        description={<>Graphic dynamism, chromatic prints and the study of carpet signs are revealed on the unprecedented surface, balanced but above all authentic. The collection, created with the innovative Stride Up technology, has a unique surface softness and high slip resistance, a winning combination that meets all safety and ease of maintenance requirements.
Ceragres maximizes the chromatic and graphic richness of the surfaces. </>}
