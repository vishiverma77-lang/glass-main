...
export default function ShopBySpecchioOro() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Specchio%20Oro`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY SPECCHIO ORO</>}
        description={<> Specchio in Italian language means mirror. Ceragres Luxe Specchio Oro collection means gold in mirror finish.  Elevate your space effortlessly, as each mirror reflects not just light, but also your exquisite taste.
Specchio Oro offers a perfect blend of modern design and classic elegance.</>}
