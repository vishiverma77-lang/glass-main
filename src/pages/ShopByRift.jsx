...
export default function ShopByRift() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Rift`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY RIFT</>}
        description={<> Unveil a new dimension flooring with the divided long hexagon in porcelain stoneware. This striking geometric shape features diverse effects like cement, carpet, wood, italian travertine and even a dark emperador, providing opportunities for designers and architects to create captivating patterns that elevate interiors to a whole new level.
Experience the extraordinary with this versatile flooring option</>}
