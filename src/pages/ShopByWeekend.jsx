...
export default function ShopByWeekend() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Weekend`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY WEEKEND</>}
        description={<>Bring a touch of nature into your space with our 45°chevron parquet flooring, offered in light oak, dark oak, and deep dark walnut. 
This exceptional flooring option is perfect for enhancing the ambiance of homes, hotels, offices and restaurants. Crafted from sturdy porcelain stoneware, it combines the natural aesthetic of wood with the resilience you need. Let your space shine with our stylish wood-inspired flooring solutions </>}
