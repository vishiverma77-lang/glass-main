...
export default function ShopByCarpet() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Carpet`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <ShopHero
        title={<>SHOP THE CARPET EFFECTS</>}
        description={<> Redefine your flooring with our exquisite porcelain stoneware that draws inspiration from the carpet industry. Each piece showcases stunning designs and textures while offering incredible durability for a lifetime. Transform your space into a stylish sanctuary that stands the test of time.
        </>}
        imageSrc="/images/Carpet.jpeg"
      />
