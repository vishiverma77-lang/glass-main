...
export default function ShopByChelsea() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Chelsea`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY CHELSEA</>}
        description={<>Embrace the beauty of our hexagon wooden parquet flooring, designed with slim trims that showcase its vivid character. Available luxurious shades of dark oak and teak, as well as a captivating mix, this flooring is perfect for upscale interiors. The combination with dark emperador Italian marble porcelain stoneware makes it truly outstanding, providing a touch of ultra-luxe elegance. </>}
        imageSrc="/images/Chelsea.jpeg"
      />
      <ShopFilterBar />
