...
export default function ShopByCromatica() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Cromatica`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY  CROMATICA</>}
        description={<> Unveil the artistry of contemporary ceramics characterized by their unconventional designs. Step into a realm of artistic expression with our unconventional contemporary ceramics. The interwoven threads on the surface create a dynamic visual experience, while the fencing design adds an innovative touch. Each is a masterpiece, showcasing a chain-linked mesh and subtle weaving techniques that form bold geometric patterns.  </>}
        imageSrc="/images/Cromatica.jpeg"
      />
      <ShopFilterBar />
