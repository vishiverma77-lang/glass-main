...
export default function ShopByBeige() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Beige`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        ...
        description={<> A versatile shade suitable for all styles. It warms and illuminates, invites and welcome: beige is a subtle, neutral colour, easy to mix and match, that inspires a mood of relaxation. Beige reflects warmth and delicacy. Colour beige always offers pure, warm and welcoming atmospheres. </>}
        imageSrc="/images/Beige.jpeg"
      />
      <ShopFilterBar />
