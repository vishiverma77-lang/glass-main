...
export default function ShopByMashup() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Mashup`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY MASHUP</>}
        description={<>Mashup comprises of a decorative collection that celebrates Nature and gives it a starring role. It is a response to the “Botanical trend”: wall and floor coverings featuring distinctive, appealing textures and the colours of lush dry leaves and grass.
An idea of “nature”, extremely decorative and perfect for the striking surfaces. </>}
        imageSrc="/images/Mashup.jpeg"
      />
      <ShopFilterBar />
