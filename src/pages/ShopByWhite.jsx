...
export default function ShopByWhite() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=White`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <ShopHero
        ...
        description={<> Always on trend and a sure bet for all type of surfaces. White porcelain stoneware embody a design choice that enhances spaces of any size, creating brightness and a feeling of spaciousness. White represents brilliance and purity. It make environments to be defined by simplicity and harmony.   </>}
        imageSrc="/images/White Porcelain.jpeg"
      />
      <ShopFilterBar />
