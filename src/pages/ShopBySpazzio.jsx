...
export default function ShopBySpazzio() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products?search=Spazzio`);
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
            <ShopHero 
        title={<>SHOP BY SPAZZIO</>}
        description={<>Walk the art of flooring with our groundbreaking parquet designs that bring a fresh perspective to luxury interiors. The rich shades of walnut and dark oak, enhanced by elegant dark emperador inlays, creating a sophisticated canvas for designers. Perfect for high-end spaces, these parquets explore and inspire stunning floor design. Ideal for ultra-luxurious spaces, they combine functionality with exquisite style. Ceragres Luxe floors offer a playground for designers to express their creativity. </>}
        imageSrc="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?q=80&w=1400&auto=format&fit=crop"
      />
      <ShopFilterBar />
